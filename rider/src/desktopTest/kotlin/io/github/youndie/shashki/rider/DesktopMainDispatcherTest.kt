 ...
 * `Could not create instance for ClassPickerViewModel` — a message about Koin for a missing
 * dependency. That is how the desktop rider failed the first time anybody ran it against the stand.
 *
 * **`RiderGraphTest` cannot catch this and it was measured, not assumed:** removing the artefact and
