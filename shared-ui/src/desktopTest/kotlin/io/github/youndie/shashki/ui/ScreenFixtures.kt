                ...
                listOf(
                    TripMonth(
                        ...
                        listOf(
                            TripRow(
                                id = "ride-3",
                                title = "46.0511, 14.5051 — 46.2237, 14.4576",
                                from = "46.0511, 14.5051",
                                to = "46.2237, 14.4576",
                                meta = "2 september · 19:40 · economy",
                                amount = "$ 28.96",
                                note = "card-4417",
                                accent = true,
                            ),
                            TripRow(
                                id = "ride-2",
                                title = "46.0511, 14.5051 — 46.0620, 14.5350",
                                from = "46.0511, 14.5051",
                                to = "46.0620, 14.5350",
                                meta = "1 september · 08:12 · economy · cancelled",
                                amount = "$ 7.24",
                            ),
                        ),
                    ),
                    TripMonth(
                        ...
                        listOf(
                            TripRow(
                                id = "ride-1",
                                title = "46.0620, 14.5350 — 46.0511, 14.5051",
                                from = "46.0620, 14.5350",
                                to = "46.0511, 14.5051",
                                meta = "28 august · 12:05 · comfort · cancelled",
                                amount = "$ 0",
                            ),
                        ),
                    ),
